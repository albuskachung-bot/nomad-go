...
export const mockJobs: Job[] = [
  {
    ...
    job_type: "全職遠端",
    category: "軟體與系統工程 (Software & Engineering)",
    experience_level: "資深 (Senior)",
    employment_type: "全職 (Full-time)",
    salary_range: "USD 72k - 110k",
    tags: ["React", "TypeScript", "SaaS"],
    description:
      "與跨時區產品團隊合作，負責設計系統、前台效能與核心儀表板體驗。",
    responsibilities: "負責設計系統、前台效能與核心儀表板體驗，並與跨時區產品團隊合作交付功能。",
    requirements: "熟悉 React、TypeScript、前端效能優化與 SaaS 產品開發流程。",
    nice_to_haves: "具備 Design System 或遠端團隊協作經驗。",
    benefits: "全遠端工作、彈性工時、年度學習預算。",
  ...
  },
  {
    ...
    job_type: "全職遠端",
    category: "數位行銷與公關 (Marketing & PR)",
    experience_level: "中階 (Mid-Level)",
    employment_type: "全職 (Full-time)",
    salary_range: "USD 55k - 82k",
    tags: ["B2B", "SEO", "Analytics"],
    description:
      "規劃華語與東南亞市場的內容成長策略，建立可追蹤的獲客漏斗。",
    responsibilities: "規劃華語與東南亞市場內容成長策略，建立可追蹤的獲客漏斗。",
    requirements: "熟悉 B2B marketing、SEO、analytics 與跨市場 campaign 執行。",
    nice_to_haves: "具備遠端工作品牌或 SaaS 成長經驗。",
    benefits: "遠端工作、彈性休假、行銷工具預算。",
  ...
  },
  {
    ...
    job_type: "合約",
    category: "UI/UX 與視覺設計 (Design & UI/UX)",
    experience_level: "中階 (Mid-Level)",
    employment_type: "約聘 (Contract)",
    salary_range: "USD 45 - 70 / hr",
    tags: ["Figma", "Design System", "B2B"],
    description:
      "負責遠端協作產品的端到端 UX，從探索、原型到高保真 UI 交付。",
    responsibilities: "負責遠端協作產品的端到端 UX，從探索、原型到高保真 UI 交付。",
    requirements: "熟悉 Figma、UX research、B2B SaaS 介面設計與設計系統。",
    nice_to_haves: "具備跨時區產品團隊合作或可用性測試經驗。",
    benefits: "遠端合約、彈性排程、可長期合作。",
  ...
  },
  {
    ...
    location: "Remote / SEA",
    job_type: "兼職",
    category: "客戶成功與支援 (Customer Success & Support)",
    experience_level: "初階 (Junior)",
    employment_type: "兼職 (Part-time)",
    salary_range: "USD 24 - 36 / hr",
    tags: ["CRM", "English", "Onboarding"],
    description:
      "協助全球使用者導入遠端工具，整理常見問題並回饋產品團隊。",
    responsibilities: "協助全球使用者導入遠端工具，整理常見問題並回饋產品團隊。",
    requirements: "具備英文溝通能力、CRM 使用經驗與客戶成功基礎概念。",
    nice_to_haves: "熟悉遠端工具導入或 SaaS onboarding。",
    benefits: "兼職遠端、彈性班表、產品訓練資源。",
  ...
  },
  {
    ...
    responsibilities: "打造多幣別帳務服務與可靠 API，維護資料一致性與服務可靠度。",
    requirements: "熟悉 Node.js、PostgreSQL、API 設計、資料建模與 observability。",
    nice_to_haves: "具備 Fintech、帳務系統或高可靠後端服務經驗。",
    benefits: "全遠端工作、設備補助、技術會議預算。",
